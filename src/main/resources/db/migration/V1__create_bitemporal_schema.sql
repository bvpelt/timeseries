...
CREATE INDEX idx_person_current ON person (uid, valid_from, valid_to) WHERE transaction_to = '9999-12-31 23:59:59+00'::TIMESTAMPTZ;
...
CREATE INDEX idx_address_current ON address (uid, valid_from, valid_to) WHERE transaction_to = '9999-12-31 23:59:59+00'::TIMESTAMPTZ;
...
CREATE INDEX idx_agreement_current ON agreement (uid, valid_from, valid_to) WHERE transaction_to = '9999-12-31 23:59:59+00'::TIMESTAMPTZ;
...
CREATE INDEX idx_person_address_current_home ON person_address (person_uid, valid_from, valid_to) WHERE address_type = 'HOME'
